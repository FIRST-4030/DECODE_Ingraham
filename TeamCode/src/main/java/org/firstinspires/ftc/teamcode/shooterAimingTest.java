...
@TeleOp(name="shooterAimingTest", group="Linear OpMode")
public class shooterAimingTest extends LinearOpMode {
    private static final boolean USE_WEBCAM = true;  // true for webcam, false for phone camera
    private static double rangeAprilTag;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                ...
                telemetry.addData("shooterVelocity", shooter.getVelocity(AngleUnit.RADIANS));
        ...
        for (AprilTagDetection detection : currentDetections) {
            if (detection.metadata != null) {
                ...
                // if (oldValue != newValue) {
                    // Min-max scaling
                    // shooterPower = (rangeAprilTag - minRange) / (maxRange - minRange);
                    //shooter.setPower(shooterPower);
